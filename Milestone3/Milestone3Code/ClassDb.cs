...
namespace Milestone3.DataAccess
{
    class ClassDb
    {
        ...
        public String EditPlayer(string pUserName, string pNewEmail, string pNewPassword, bool pNewAdminStatus, bool pNewLockedStatus)
        {
            List<MySqlParameter> parList = new List<MySqlParameter>();
            var parUserName = new MySqlParameter("@UserName", MySqlDbType.VarChar, 20);
